                        ...
                        <div class="card-body">                            
                            <div class="row inbox-row pt-2">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <b>{{$message->attorney->firstname}} {{$message->attorney->lastname}}<small class="text-muted">({{$message->attorney->email}})</small></b>
                                    <br>
                                    <small class=" pt-0 text-secondary"><b>to {{$message->user->name}} {{$message->user->lastname}}</b></small>
                                     ...
                                     <div class="btn-group">
                                         ...
                                         <a class="dropdown-item" href="#"><small class="text-muted">from: <b>{{$message->attorney->firsrname}} {{$message->attorney->lastname}}</b>({{$message->attorney->email}})</small></a>
