        ...
        <div class="user-nav">
            ...
            <div class="p-0">
              <ul class="nav user-nav-tabs nav-fill ml-auto pt-0" style="flex-direction:column;">
                ...
                <li class="nav-item user-nav-item"><a class="nav-link user-nav-link " href="#tab9" data-toggle="tab"><span > <img src="/images/questions.png"  style="height:22px;width:22px;" alt="" srcset=""></span> Questions Answered</a></li>
                                    ...
                                    <li> 
                                        <div class="row pt-2">
                                            ...
                                            <div class="float-right col-md-10 ml-0">
                                                <span><a href="/profile/{{$endorsment->endorser->id}}">{{$endorsment->endorser->firstname}} {{$endorsment->endorser->lastname}}</a></span>
