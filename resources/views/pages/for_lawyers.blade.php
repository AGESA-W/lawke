    ...
    {{-- <div class="about">
        <div class="about-jumbotron">
            <div class="about text-center">
                <h1 class="about-jumbotron-text"><strong>Get the Legal clients you need!</strong></h1>
    ...
    <div class="about">
        <div class="about-jumbotron">
            <div class="jumbotron text-center">
                <h3 class="about-jumbotron-text"><strong>Get the Legal clients you  <br> need now ! </strong></h3>
                <a href="/" class="btn bg-color"><span class="fa fa-arrow-left"></span> Back to homepage</a>

            </div>
        </div>
    </div>
    <div class="for-lawyers" style="margin-top:410px;">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="card"  style="height:250px;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <p class="pt-5"><b> Already have an account </b></p>
                            <a href="/attorney_login" class="text-decoration-none btn btn-sm btn-outline-primary px-3 py-2" >Login <i class="fa fa-sign-in" aria-hidden="true"></i></a>
                        </div>
            ...
            <div class="col-md-6">
                ...
                <div class="card" style="height:250px;">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                                <p class="text-center pt-5"><b> New to Legal<span class="text-color">meet</span>? Create an account.</b></p>
                            <a href="/attorney_register" class="text-decoration-none btn btn-sm btn-outline-success px-3 py-2" >Register <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
