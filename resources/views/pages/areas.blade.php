                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <ul class="list-unstyled">
                            <li class="pt-2"> <a href="/practice-areas/{{$practicearea->area_practice}}/{{$location->county}}" class="attorney-card-link text-decoration-none">{{$location->county}} Lawyers</a> </li>
                        </ul>
                    </div>
                    @endforeach
                </div>
